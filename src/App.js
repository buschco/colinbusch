        ...
        <div className="App">
          <div className="header" style={styles(this.state.index).header}>
            <NavLink
              ...
              className="nav-link"
              activeStyle={styles(this.state.index).active}
              style={styles(this.state.index).a}
              to="/"
            >
              index
            </NavLink>
          ...
          <Route
            ...
            path="/"
            render={() => (
              <Index index={this.state.index} images={this.state.data} />
            )}
          />
          <Route
            path="/about"
            render={() => (
              <About index={this.state.index} images={this.state.data} />
            )}
          />
